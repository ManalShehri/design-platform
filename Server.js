...
المطلوب:
- إعادة صياغة النصوص التالية في سياق تعريف رسمي تقني.
- حسّن الوضوح، والترابط، والأسلوب، لكن:
  ...
  - الطول المطلوب ( متوسط مثلا زياده سطرين فقط حسب المدخل )
  - اذا كان نص المحتوى من أصله قصير (اضف محتوى بون تغيير للمعنى بحيث يصبح لايتعدى مجموع الاسطر ٤ اسطر)
  - اذا كان نص المحتوى طويل (عدل الصياغة والاملاء حسب الحاجة وزيادة بالكثير سطر فقط)
